...
//        setSupportActionBar(toolbar);
    ...
    public void DataLoadedHandler(ArrayList<PXLPhoto> photos) {
        ...
        listAdapter = new ListAdapter(this, photoList, SampleActivity.this);
        listView.setAdapter(listAdapter);
        listAdapter.notifyDataSetChanged();

        gridAdapter = new GridAdapter(this, photoList, SampleActivity.this);
    ...
    private void configureViews() {
        ...
        gridAdapter = new GridAdapter(getApplicationContext(), photoList, this);
        listAdapter = new ListAdapter(getApplicationContext(), photoList, this);
        gridView.setAdapter(gridAdapter);
        listView.setAdapter(listAdapter);
...
//        album.loadNextPageOfPhotos(rh);
    ...
    private void updateDetailView(PXLPhoto photo) {
        ...
        if (photo.cdnOriginalUrl!=null){
          ...
          //  this.detailSourceIcon.setImageResource(photo.cdnOriginalUrl.toString());
        }

        //this.detailImage.setImageUrl(photo.getUrlForSize(PXLPhotoSize.THUMBNAIL).toString(), PXLClient.getInstance(this).getImageLoader());
        this.detailImage.setImageUrl(photo.cdnOriginalUrl.toString(), PXLClient.getInstance(this).getImageLoader());
